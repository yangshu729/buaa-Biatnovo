...
class TrainingModel(nn.Module):
    ...
    def forward(self, opt, spectrum_holder, intensity_inputs_forward, intensity_inputs_backward, decoder_inputs_forward,
        ...
        if training_mode:
            ...
            output_transformer_forward, output_transformer_backward = self.transformer(decoder_inputs_forward_trans,
    ...
    def Inference_SB(self, spectrum_cnn_outputs, candidate_intensity_l2r, candidate_intensity_r2l,
        ...
        output_transformer_forward, output_transformer_backward = self.transformer(decoder_inputs_trans_l2r, decoder_inputs_trans_r2l,
                                                                                   trg_mask, spectrum_cnn_outputs, src_mask)
        output_transformer_forward = output_transformer_forward[:, -1, :]
        output_transformer_backward = output_transformer_backward[:, -1, :]

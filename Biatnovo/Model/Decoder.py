...
class DecoderLayer(nn.Module):
    ...
    def forward(
            self, dec_input_q, dec_input_kv, enc_output,
            slf_attn_mask=None, dec_enc_attn_mask=None):

        dec_output, dec_slf_attn = self.slf_attn(
            dec_input_q, dec_input_kv, dec_input_kv, mode=True, mask=slf_attn_mask)
        dec_output, dec_enc_attn = self.enc_attn(
            dec_output, enc_output, enc_output, mode=False, mask=dec_enc_attn_mask)

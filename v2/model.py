...
class InferenceModelWrapper(object):
    def __init__(self, forward_model : DeepNovoAttion, backward_model : DeepNovoAttion, sepctrum_cnn : SpectrumCNN2):
        self.forward_model = forward_model
        self.backward_model = backward_model
        self.spectrum_cnn = sepctrum_cnn
    ...
    def init_spectrum_cnn(self, spectrum_holder: torch.Tensor):
        with torch.no_grad():
            ...
            return self.model.spectrum_cnn(spectrum_holder).permute(1, 0, 2)

    def inference(self, spectrum_cnn_outputs, candidate_intensity, decoder_inputs, direction : Direction):
